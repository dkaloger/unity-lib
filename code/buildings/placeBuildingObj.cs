...
public class placeBuildingObj : MonoBehaviour
{

    public bool orderWheelOnP;
    ...
    void Update()
    {
        ...
        currentlySelectedObject = selectableObjects[1];

        if (Input.GetKeyDown("l") && isAnObjectSelected == false)
        {
    ...
    public void tierChange(float tier)
    {

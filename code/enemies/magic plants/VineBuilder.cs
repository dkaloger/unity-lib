...
/// <summary>
/// This was originally RopeBuilder from SplineMesh. It has been modified to 
/// keep up with the mechanics of the Vine. And to not be overwritten by
/// updates to SplineMesh.
/// </summary>
[ExecuteInEditMode]
[RequireComponent(typeof(Spline))]
public class VineBuilder : MonoBehaviour 
{
    float splineToRigidbodyPosition = 0f; //Maybe interpolate between the spline position to the rigidbody?
